...
public class DLJ_OnComClick : MonoBehaviour
{
    [SerializeField] private GameObject camera;
    [SerializeField] private Camera raycastCamera;

    private readonly Vector3 targetPosition = new Vector3(1.56f, 4.63f, -16.3f);
    private readonly Vector3 targetRotation = new Vector3(12.04f, -0.17f, 0f);
